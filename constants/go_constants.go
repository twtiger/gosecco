...
func init() {
	...
	syscalls["read"] = syscall.SYS_READ
	syscalls["write"] = syscall.SYS_WRITE
	syscalls["open"] = syscall.SYS_OPEN
	syscalls["close"] = syscall.SYS_CLOSE
	syscalls["stat"] = syscall.SYS_STAT
	syscalls["fstat"] = syscall.SYS_FSTAT
	syscalls["lstat"] = syscall.SYS_LSTAT
	syscalls["poll"] = syscall.SYS_POLL
	syscalls["lseek"] = syscall.SYS_LSEEK
	syscalls["mmap"] = syscall.SYS_MMAP
	syscalls["mprotect"] = syscall.SYS_MPROTECT
	syscalls["munmap"] = syscall.SYS_MUNMAP
	syscalls["brk"] = syscall.SYS_BRK
	syscalls["rt_sigaction"] = syscall.SYS_RT_SIGACTION
	syscalls["rt_sigprocmask"] = syscall.SYS_RT_SIGPROCMASK
	syscalls["rt_sigreturn"] = syscall.SYS_RT_SIGRETURN
	syscalls["ioctl"] = syscall.SYS_IOCTL
	syscalls["pread64"] = syscall.SYS_PREAD64
	syscalls["pwrite64"] = syscall.SYS_PWRITE64
	syscalls["readv"] = syscall.SYS_READV
	syscalls["writev"] = syscall.SYS_WRITEV
	syscalls["access"] = syscall.SYS_ACCESS
	syscalls["pipe"] = syscall.SYS_PIPE
	syscalls["select"] = syscall.SYS_SELECT
	syscalls["sched_yield"] = syscall.SYS_SCHED_YIELD
	syscalls["mremap"] = syscall.SYS_MREMAP
	syscalls["msync"] = syscall.SYS_MSYNC
	syscalls["mincore"] = syscall.SYS_MINCORE
	syscalls["madvise"] = syscall.SYS_MADVISE
	syscalls["shmget"] = syscall.SYS_SHMGET
	syscalls["shmat"] = syscall.SYS_SHMAT
	syscalls["shmctl"] = syscall.SYS_SHMCTL
	syscalls["dup"] = syscall.SYS_DUP
	syscalls["dup2"] = syscall.SYS_DUP2
	syscalls["pause"] = syscall.SYS_PAUSE
	syscalls["nanosleep"] = syscall.SYS_NANOSLEEP
	syscalls["getitimer"] = syscall.SYS_GETITIMER
	syscalls["alarm"] = syscall.SYS_ALARM
	syscalls["setitimer"] = syscall.SYS_SETITIMER
	syscalls["getpid"] = syscall.SYS_GETPID
	syscalls["sendfile"] = syscall.SYS_SENDFILE
	syscalls["socket"] = syscall.SYS_SOCKET
	syscalls["connect"] = syscall.SYS_CONNECT
	syscalls["accept"] = syscall.SYS_ACCEPT
	syscalls["sendto"] = syscall.SYS_SENDTO
	syscalls["recvfrom"] = syscall.SYS_RECVFROM
	syscalls["sendmsg"] = syscall.SYS_SENDMSG
	syscalls["recvmsg"] = syscall.SYS_RECVMSG
	syscalls["shutdown"] = syscall.SYS_SHUTDOWN
	syscalls["bind"] = syscall.SYS_BIND
	syscalls["listen"] = syscall.SYS_LISTEN
	syscalls["getsockname"] = syscall.SYS_GETSOCKNAME
	syscalls["getpeername"] = syscall.SYS_GETPEERNAME
	syscalls["socketpair"] = syscall.SYS_SOCKETPAIR
	syscalls["setsockopt"] = syscall.SYS_SETSOCKOPT
	syscalls["getsockopt"] = syscall.SYS_GETSOCKOPT
	syscalls["clone"] = syscall.SYS_CLONE
	syscalls["fork"] = syscall.SYS_FORK
	syscalls["vfork"] = syscall.SYS_VFORK
	syscalls["execve"] = syscall.SYS_EXECVE
	syscalls["exit"] = syscall.SYS_EXIT
	syscalls["wait4"] = syscall.SYS_WAIT4
	syscalls["kill"] = syscall.SYS_KILL
	syscalls["uname"] = syscall.SYS_UNAME
	syscalls["semget"] = syscall.SYS_SEMGET
	syscalls["semop"] = syscall.SYS_SEMOP
	syscalls["semctl"] = syscall.SYS_SEMCTL
	syscalls["shmdt"] = syscall.SYS_SHMDT
	syscalls["msgget"] = syscall.SYS_MSGGET
	syscalls["msgsnd"] = syscall.SYS_MSGSND
	syscalls["msgrcv"] = syscall.SYS_MSGRCV
	syscalls["msgctl"] = syscall.SYS_MSGCTL
	syscalls["fcntl"] = syscall.SYS_FCNTL
	syscalls["flock"] = syscall.SYS_FLOCK
	syscalls["fsync"] = syscall.SYS_FSYNC
	syscalls["fdatasync"] = syscall.SYS_FDATASYNC
	syscalls["truncate"] = syscall.SYS_TRUNCATE
	syscalls["ftruncate"] = syscall.SYS_FTRUNCATE
	syscalls["getdents"] = syscall.SYS_GETDENTS
	syscalls["getcwd"] = syscall.SYS_GETCWD
	syscalls["chdir"] = syscall.SYS_CHDIR
	syscalls["fchdir"] = syscall.SYS_FCHDIR
	syscalls["rename"] = syscall.SYS_RENAME
	syscalls["mkdir"] = syscall.SYS_MKDIR
	syscalls["rmdir"] = syscall.SYS_RMDIR
	syscalls["creat"] = syscall.SYS_CREAT
	syscalls["link"] = syscall.SYS_LINK
	syscalls["unlink"] = syscall.SYS_UNLINK
	syscalls["symlink"] = syscall.SYS_SYMLINK
	syscalls["readlink"] = syscall.SYS_READLINK
	syscalls["chmod"] = syscall.SYS_CHMOD
	syscalls["fchmod"] = syscall.SYS_FCHMOD
	syscalls["chown"] = syscall.SYS_CHOWN
	syscalls["fchown"] = syscall.SYS_FCHOWN
	syscalls["lchown"] = syscall.SYS_LCHOWN
	syscalls["umask"] = syscall.SYS_UMASK
	syscalls["gettimeofday"] = syscall.SYS_GETTIMEOFDAY
	syscalls["getrlimit"] = syscall.SYS_GETRLIMIT
	syscalls["getrusage"] = syscall.SYS_GETRUSAGE
	syscalls["sysinfo"] = syscall.SYS_SYSINFO
	syscalls["times"] = syscall.SYS_TIMES
	syscalls["ptrace"] = syscall.SYS_PTRACE
	syscalls["getuid"] = syscall.SYS_GETUID
	syscalls["syslog"] = syscall.SYS_SYSLOG
	syscalls["getgid"] = syscall.SYS_GETGID
	syscalls["setuid"] = syscall.SYS_SETUID
	syscalls["setgid"] = syscall.SYS_SETGID
	syscalls["geteuid"] = syscall.SYS_GETEUID
	syscalls["getegid"] = syscall.SYS_GETEGID
	syscalls["setpgid"] = syscall.SYS_SETPGID
	syscalls["getppid"] = syscall.SYS_GETPPID
	syscalls["getpgrp"] = syscall.SYS_GETPGRP
	syscalls["setsid"] = syscall.SYS_SETSID
	syscalls["setreuid"] = syscall.SYS_SETREUID
	syscalls["setregid"] = syscall.SYS_SETREGID
	syscalls["getgroups"] = syscall.SYS_GETGROUPS
	syscalls["setgroups"] = syscall.SYS_SETGROUPS
	syscalls["setresuid"] = syscall.SYS_SETRESUID
	syscalls["getresuid"] = syscall.SYS_GETRESUID
	syscalls["setresgid"] = syscall.SYS_SETRESGID
	syscalls["getresgid"] = syscall.SYS_GETRESGID
	syscalls["getpgid"] = syscall.SYS_GETPGID
	syscalls["setfsuid"] = syscall.SYS_SETFSUID
	syscalls["setfsgid"] = syscall.SYS_SETFSGID
	syscalls["getsid"] = syscall.SYS_GETSID
	syscalls["capget"] = syscall.SYS_CAPGET
	syscalls["capset"] = syscall.SYS_CAPSET
	syscalls["rt_sigpending"] = syscall.SYS_RT_SIGPENDING
	syscalls["rt_sigtimedwait"] = syscall.SYS_RT_SIGTIMEDWAIT
	syscalls["rt_sigqueueinfo"] = syscall.SYS_RT_SIGQUEUEINFO
	syscalls["rt_sigsuspend"] = syscall.SYS_RT_SIGSUSPEND
	syscalls["sigaltstack"] = syscall.SYS_SIGALTSTACK
	syscalls["utime"] = syscall.SYS_UTIME
	syscalls["mknod"] = syscall.SYS_MKNOD
	syscalls["uselib"] = syscall.SYS_USELIB
	syscalls["personality"] = syscall.SYS_PERSONALITY
	syscalls["ustat"] = syscall.SYS_USTAT
	syscalls["statfs"] = syscall.SYS_STATFS
	syscalls["fstatfs"] = syscall.SYS_FSTATFS
	syscalls["sysfs"] = syscall.SYS_SYSFS
	syscalls["getpriority"] = syscall.SYS_GETPRIORITY
	syscalls["setpriority"] = syscall.SYS_SETPRIORITY
	syscalls["sched_setparam"] = syscall.SYS_SCHED_SETPARAM
	syscalls["sched_getparam"] = syscall.SYS_SCHED_GETPARAM
	syscalls["sched_setscheduler"] = syscall.SYS_SCHED_SETSCHEDULER
	syscalls["sched_getscheduler"] = syscall.SYS_SCHED_GETSCHEDULER
	syscalls["sched_get_priority_max"] = syscall.SYS_SCHED_GET_PRIORITY_MAX
	syscalls["sched_get_priority_min"] = syscall.SYS_SCHED_GET_PRIORITY_MIN
	syscalls["sched_rr_get_interval"] = syscall.SYS_SCHED_RR_GET_INTERVAL
	syscalls["mlock"] = syscall.SYS_MLOCK
	syscalls["munlock"] = syscall.SYS_MUNLOCK
	syscalls["mlockall"] = syscall.SYS_MLOCKALL
	syscalls["munlockall"] = syscall.SYS_MUNLOCKALL
	syscalls["vhangup"] = syscall.SYS_VHANGUP
	syscalls["modify_ldt"] = syscall.SYS_MODIFY_LDT
	syscalls["pivot_root"] = syscall.SYS_PIVOT_ROOT
	syscalls["_sysctl"] = syscall.SYS__SYSCTL
	syscalls["prctl"] = syscall.SYS_PRCTL
	syscalls["arch_prctl"] = syscall.SYS_ARCH_PRCTL
	syscalls["adjtimex"] = syscall.SYS_ADJTIMEX
	syscalls["setrlimit"] = syscall.SYS_SETRLIMIT
	syscalls["chroot"] = syscall.SYS_CHROOT
	syscalls["sync"] = syscall.SYS_SYNC
	syscalls["acct"] = syscall.SYS_ACCT
	syscalls["settimeofday"] = syscall.SYS_SETTIMEOFDAY
	syscalls["mount"] = syscall.SYS_MOUNT
	syscalls["umount2"] = syscall.SYS_UMOUNT2
	syscalls["swapon"] = syscall.SYS_SWAPON
	syscalls["swapoff"] = syscall.SYS_SWAPOFF
	syscalls["reboot"] = syscall.SYS_REBOOT
	syscalls["sethostname"] = syscall.SYS_SETHOSTNAME
	syscalls["setdomainname"] = syscall.SYS_SETDOMAINNAME
	syscalls["iopl"] = syscall.SYS_IOPL
	syscalls["ioperm"] = syscall.SYS_IOPERM
	syscalls["create_module"] = syscall.SYS_CREATE_MODULE
	syscalls["init_module"] = syscall.SYS_INIT_MODULE
	syscalls["delete_module"] = syscall.SYS_DELETE_MODULE
	syscalls["get_kernel_syms"] = syscall.SYS_GET_KERNEL_SYMS
	syscalls["query_module"] = syscall.SYS_QUERY_MODULE
	syscalls["quotactl"] = syscall.SYS_QUOTACTL
	syscalls["nfsservctl"] = syscall.SYS_NFSSERVCTL
	syscalls["getpmsg"] = syscall.SYS_GETPMSG
	syscalls["putpmsg"] = syscall.SYS_PUTPMSG
	syscalls["afs_syscall"] = syscall.SYS_AFS_SYSCALL
	syscalls["tuxcall"] = syscall.SYS_TUXCALL
	syscalls["security"] = syscall.SYS_SECURITY
	syscalls["gettid"] = syscall.SYS_GETTID
	syscalls["readahead"] = syscall.SYS_READAHEAD
	syscalls["setxattr"] = syscall.SYS_SETXATTR
	syscalls["lsetxattr"] = syscall.SYS_LSETXATTR
	syscalls["fsetxattr"] = syscall.SYS_FSETXATTR
	syscalls["getxattr"] = syscall.SYS_GETXATTR
	syscalls["lgetxattr"] = syscall.SYS_LGETXATTR
	syscalls["fgetxattr"] = syscall.SYS_FGETXATTR
	syscalls["listxattr"] = syscall.SYS_LISTXATTR
	syscalls["llistxattr"] = syscall.SYS_LLISTXATTR
	syscalls["flistxattr"] = syscall.SYS_FLISTXATTR
	syscalls["removexattr"] = syscall.SYS_REMOVEXATTR
	syscalls["lremovexattr"] = syscall.SYS_LREMOVEXATTR
	syscalls["fremovexattr"] = syscall.SYS_FREMOVEXATTR
	syscalls["tkill"] = syscall.SYS_TKILL
	syscalls["time"] = syscall.SYS_TIME
	syscalls["futex"] = syscall.SYS_FUTEX
	syscalls["sched_setaffinity"] = syscall.SYS_SCHED_SETAFFINITY
	syscalls["sched_getaffinity"] = syscall.SYS_SCHED_GETAFFINITY
	syscalls["set_thread_area"] = syscall.SYS_SET_THREAD_AREA
	syscalls["io_setup"] = syscall.SYS_IO_SETUP
	syscalls["io_destroy"] = syscall.SYS_IO_DESTROY
	syscalls["io_getevents"] = syscall.SYS_IO_GETEVENTS
	syscalls["io_submit"] = syscall.SYS_IO_SUBMIT
	syscalls["io_cancel"] = syscall.SYS_IO_CANCEL
	syscalls["get_thread_area"] = syscall.SYS_GET_THREAD_AREA
	syscalls["lookup_dcookie"] = syscall.SYS_LOOKUP_DCOOKIE
	syscalls["epoll_create"] = syscall.SYS_EPOLL_CREATE
	syscalls["epoll_ctl_old"] = syscall.SYS_EPOLL_CTL_OLD
	syscalls["epoll_wait_old"] = syscall.SYS_EPOLL_WAIT_OLD
	syscalls["remap_file_pages"] = syscall.SYS_REMAP_FILE_PAGES
	syscalls["getdents64"] = syscall.SYS_GETDENTS64
	syscalls["set_tid_address"] = syscall.SYS_SET_TID_ADDRESS
	syscalls["restart_syscall"] = syscall.SYS_RESTART_SYSCALL
	syscalls["semtimedop"] = syscall.SYS_SEMTIMEDOP
	syscalls["fadvise64"] = syscall.SYS_FADVISE64
	syscalls["timer_create"] = syscall.SYS_TIMER_CREATE
	syscalls["timer_settime"] = syscall.SYS_TIMER_SETTIME
	syscalls["timer_gettime"] = syscall.SYS_TIMER_GETTIME
	syscalls["timer_getoverrun"] = syscall.SYS_TIMER_GETOVERRUN
	syscalls["timer_delete"] = syscall.SYS_TIMER_DELETE
	syscalls["clock_settime"] = syscall.SYS_CLOCK_SETTIME
	syscalls["clock_gettime"] = syscall.SYS_CLOCK_GETTIME
	syscalls["clock_getres"] = syscall.SYS_CLOCK_GETRES
	syscalls["clock_nanosleep"] = syscall.SYS_CLOCK_NANOSLEEP
	syscalls["exit_group"] = syscall.SYS_EXIT_GROUP
	syscalls["epoll_wait"] = syscall.SYS_EPOLL_WAIT
	syscalls["epoll_ctl"] = syscall.SYS_EPOLL_CTL
	syscalls["tgkill"] = syscall.SYS_TGKILL
	syscalls["utimes"] = syscall.SYS_UTIMES
	syscalls["vserver"] = syscall.SYS_VSERVER
	syscalls["mbind"] = syscall.SYS_MBIND
	syscalls["set_mempolicy"] = syscall.SYS_SET_MEMPOLICY
	syscalls["get_mempolicy"] = syscall.SYS_GET_MEMPOLICY
	syscalls["mq_open"] = syscall.SYS_MQ_OPEN
	syscalls["mq_unlink"] = syscall.SYS_MQ_UNLINK
	syscalls["mq_timedsend"] = syscall.SYS_MQ_TIMEDSEND
	syscalls["mq_timedreceive"] = syscall.SYS_MQ_TIMEDRECEIVE
	syscalls["mq_notify"] = syscall.SYS_MQ_NOTIFY
	syscalls["mq_getsetattr"] = syscall.SYS_MQ_GETSETATTR
	syscalls["kexec_load"] = syscall.SYS_KEXEC_LOAD
	syscalls["waitid"] = syscall.SYS_WAITID
	syscalls["add_key"] = syscall.SYS_ADD_KEY
	syscalls["request_key"] = syscall.SYS_REQUEST_KEY
	syscalls["keyctl"] = syscall.SYS_KEYCTL
	syscalls["ioprio_set"] = syscall.SYS_IOPRIO_SET
	syscalls["ioprio_get"] = syscall.SYS_IOPRIO_GET
	syscalls["inotify_init"] = syscall.SYS_INOTIFY_INIT
	syscalls["inotify_add_watch"] = syscall.SYS_INOTIFY_ADD_WATCH
	syscalls["inotify_rm_watch"] = syscall.SYS_INOTIFY_RM_WATCH
	syscalls["migrate_pages"] = syscall.SYS_MIGRATE_PAGES
	syscalls["openat"] = syscall.SYS_OPENAT
	syscalls["mkdirat"] = syscall.SYS_MKDIRAT
	syscalls["mknodat"] = syscall.SYS_MKNODAT
	syscalls["fchownat"] = syscall.SYS_FCHOWNAT
	syscalls["futimesat"] = syscall.SYS_FUTIMESAT
	syscalls["newfstatat"] = syscall.SYS_NEWFSTATAT
	syscalls["unlinkat"] = syscall.SYS_UNLINKAT
	syscalls["renameat"] = syscall.SYS_RENAMEAT
	syscalls["linkat"] = syscall.SYS_LINKAT
	syscalls["symlinkat"] = syscall.SYS_SYMLINKAT
	syscalls["readlinkat"] = syscall.SYS_READLINKAT
	syscalls["fchmodat"] = syscall.SYS_FCHMODAT
	syscalls["faccessat"] = syscall.SYS_FACCESSAT
	syscalls["pselect6"] = syscall.SYS_PSELECT6
	syscalls["ppoll"] = syscall.SYS_PPOLL
	syscalls["unshare"] = syscall.SYS_UNSHARE
	syscalls["set_robust_list"] = syscall.SYS_SET_ROBUST_LIST
	syscalls["get_robust_list"] = syscall.SYS_GET_ROBUST_LIST
	syscalls["splice"] = syscall.SYS_SPLICE
	syscalls["tee"] = syscall.SYS_TEE
	syscalls["sync_file_range"] = syscall.SYS_SYNC_FILE_RANGE
	syscalls["vmsplice"] = syscall.SYS_VMSPLICE
	syscalls["move_pages"] = syscall.SYS_MOVE_PAGES
	syscalls["utimensat"] = syscall.SYS_UTIMENSAT
	syscalls["epoll_pwait"] = syscall.SYS_EPOLL_PWAIT
	syscalls["signalfd"] = syscall.SYS_SIGNALFD
	syscalls["timerfd_create"] = syscall.SYS_TIMERFD_CREATE
	syscalls["eventfd"] = syscall.SYS_EVENTFD
	syscalls["fallocate"] = syscall.SYS_FALLOCATE
	syscalls["timerfd_settime"] = syscall.SYS_TIMERFD_SETTIME
	syscalls["timerfd_gettime"] = syscall.SYS_TIMERFD_GETTIME
	syscalls["accept4"] = syscall.SYS_ACCEPT4
	syscalls["signalfd4"] = syscall.SYS_SIGNALFD4
	syscalls["eventfd2"] = syscall.SYS_EVENTFD2
	syscalls["epoll_create1"] = syscall.SYS_EPOLL_CREATE1
	syscalls["dup3"] = syscall.SYS_DUP3
	syscalls["pipe2"] = syscall.SYS_PIPE2
	syscalls["inotify_init1"] = syscall.SYS_INOTIFY_INIT1
	syscalls["preadv"] = syscall.SYS_PREADV
	syscalls["pwritev"] = syscall.SYS_PWRITEV
	syscalls["rt_tgsigqueueinfo"] = syscall.SYS_RT_TGSIGQUEUEINFO
	syscalls["perf_event_open"] = syscall.SYS_PERF_EVENT_OPEN
	syscalls["recvmmsg"] = syscall.SYS_RECVMMSG
	syscalls["fanotify_init"] = syscall.SYS_FANOTIFY_INIT
	syscalls["fanotify_mark"] = syscall.SYS_FANOTIFY_MARK
