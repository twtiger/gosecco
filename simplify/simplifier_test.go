...
func (s *SimplifierSuite) Test_simplifyAddition(c *C) {
	sx := Simplify(tree.Arithmetic{Op: tree.PLUS, Left: tree.NumericLiteral{Value: 1}, Right: tree.NumericLiteral{Value: 2}})
	c.Assert(tree.ExpressionString(sx), Equals, "3")
}

func (s *SimplifierSuite) Test_simplifySubtraction(c *C) {
	sx := Simplify(tree.Arithmetic{Op: tree.MINUS, Left: tree.NumericLiteral{Value: 32}, Right: tree.NumericLiteral{Value: 3}})
	c.Assert(tree.ExpressionString(sx), Equals, "29")
}

func (s *SimplifierSuite) Test_simplifyMult(c *C) {
	sx := Simplify(tree.Arithmetic{Op: tree.MULT, Left: tree.NumericLiteral{Value: 12}, Right: tree.NumericLiteral{Value: 3}})
	c.Assert(tree.ExpressionString(sx), Equals, "36")
}

func (s *SimplifierSuite) Test_simplifyDiv(c *C) {
	sx := Simplify(tree.Arithmetic{Op: tree.DIV, Left: tree.NumericLiteral{Value: 37}, Right: tree.NumericLiteral{Value: 3}})
	c.Assert(tree.ExpressionString(sx), Equals, "12")
}

func (s *SimplifierSuite) Test_simplifyMod(c *C) {
	sx := Simplify(tree.Arithmetic{Op: tree.MOD, Left: tree.NumericLiteral{Value: 37}, Right: tree.NumericLiteral{Value: 3}})
	c.Assert(tree.ExpressionString(sx), Equals, "1")
}

func (s *SimplifierSuite) Test_simplifyBinAnd(c *C) {
	sx := Simplify(tree.Arithmetic{Op: tree.BINAND, Left: tree.NumericLiteral{Value: 7}, Right: tree.NumericLiteral{Value: 4}})
	c.Assert(tree.ExpressionString(sx), Equals, "4")
}

func (s *SimplifierSuite) Test_simplifyBinOr(c *C) {
	sx := Simplify(tree.Arithmetic{Op: tree.BINOR, Left: tree.NumericLiteral{Value: 3}, Right: tree.NumericLiteral{Value: 8}})
	c.Assert(tree.ExpressionString(sx), Equals, "11")
}

func (s *SimplifierSuite) Test_simplifyBinXoe(c *C) {
	sx := Simplify(tree.Arithmetic{Op: tree.BINXOR, Left: tree.NumericLiteral{Value: 42}, Right: tree.NumericLiteral{Value: 12}})
	c.Assert(tree.ExpressionString(sx), Equals, "38")
}

func (s *SimplifierSuite) Test_simplifyLsh(c *C) {
	sx := Simplify(tree.Arithmetic{Op: tree.LSH, Left: tree.NumericLiteral{Value: 42}, Right: tree.NumericLiteral{Value: 2}})
	c.Assert(tree.ExpressionString(sx), Equals, "168")
}

func (s *SimplifierSuite) Test_simplifyRsh(c *C) {
	sx := Simplify(tree.Arithmetic{Op: tree.RSH, Left: tree.NumericLiteral{Value: 84}, Right: tree.NumericLiteral{Value: 2}})
	c.Assert(tree.ExpressionString(sx), Equals, "21")
}

func (s *SimplifierSuite) Test_simplifyCall(c *C) {
	sx := Simplify(tree.Call{"foo", []tree.Any{tree.Arithmetic{Op: tree.RSH, Left: tree.NumericLiteral{Value: 84}, Right: tree.NumericLiteral{Value: 2}}}})
...
func (s *SimplifierSuite) Test_simplifyAnd(c *C) {
	sx := Simplify(tree.And{
		tree.Comparison{
			Left:  tree.Arithmetic{Op: tree.LSH, Left: tree.NumericLiteral{Value: 42}, Right: tree.NumericLiteral{Value: 2}},
			Op:    tree.EQL,
			Right: tree.Arithmetic{Op: tree.RSH, Left: tree.NumericLiteral{Value: 42}, Right: tree.NumericLiteral{Value: 2}},
		},
		tree.Comparison{
	...
	sx = Simplify(tree.And{
		tree.Comparison{
			Left:  tree.Arithmetic{Op: tree.LSH, Left: tree.NumericLiteral{Value: 42}, Right: tree.NumericLiteral{Value: 2}},
			Op:    tree.EQL,
			Right: tree.Arithmetic{Op: tree.RSH, Left: tree.NumericLiteral{Value: 42}, Right: tree.Variable{"foo"}},
		},
		tree.Comparison{
			Left:  tree.Argument{Index: 2},
			Op:    tree.EQL,
...
func (s *SimplifierSuite) Test_simplifyComparison(c *C) {
	sx := Simplify(tree.Comparison{Left: tree.NumericLiteral{Value: 42}, Op: tree.EQL, Right: tree.NumericLiteral{Value: 41}})
	c.Assert(tree.ExpressionString(sx), Equals, "false")

	sx = Simplify(tree.Comparison{Left: tree.NumericLiteral{Value: 42}, Op: tree.NEQL, Right: tree.NumericLiteral{Value: 41}})
	c.Assert(tree.ExpressionString(sx), Equals, "true")

	sx = Simplify(tree.Comparison{Left: tree.NumericLiteral{Value: 42}, Op: tree.GT, Right: tree.NumericLiteral{Value: 41}})
	c.Assert(tree.ExpressionString(sx), Equals, "true")

	sx = Simplify(tree.Comparison{Left: tree.NumericLiteral{Value: 42}, Op: tree.GTE, Right: tree.NumericLiteral{Value: 41}})
	c.Assert(tree.ExpressionString(sx), Equals, "true")

	sx = Simplify(tree.Comparison{Left: tree.NumericLiteral{Value: 42}, Op: tree.LT, Right: tree.NumericLiteral{Value: 41}})
	c.Assert(tree.ExpressionString(sx), Equals, "false")

	sx = Simplify(tree.Comparison{Left: tree.NumericLiteral{Value: 42}, Op: tree.LTE, Right: tree.NumericLiteral{Value: 41}})
	c.Assert(tree.ExpressionString(sx), Equals, "false")
}
...
func (s *SimplifierSuite) Test_simplifyBinaryNegation(c *C) {
	sx := Simplify(tree.BinaryNegation{tree.NumericLiteral{Value: 42}})
...
func (s *SimplifierSuite) Test_simplifyInclusion(c *C) {
	sx := Simplify(tree.Inclusion{
		Positive: true,
		Left:     tree.BinaryNegation{tree.NumericLiteral{Value: 42}},
		Rights: []tree.Numeric{
			tree.NumericLiteral{Value: 42},
			tree.Arithmetic{Op: tree.LSH, Left: tree.NumericLiteral{Value: 42}, Right: tree.NumericLiteral{Value: 2}},
		}})
	c.Assert(tree.ExpressionString(sx), Equals, "false")
...
func (s *SimplifierSuite) Test_simplifyNumericLiteral(c *C) {
	sx := Simplify(tree.NumericLiteral{Value: 42})
...
func (s *SimplifierSuite) Test_NumericLiteral(c *C) {
	t := tree.NumericLiteral{Value: 42}
	sx := Simplify(t)
	c.Assert(sx, Equals, t)
}
